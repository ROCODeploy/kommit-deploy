(function() {
		...
		const mod = {
			...
			_DataVersionCacheName: 'OLSKServiceWorkerVersionCache-1673536135860',
			...
			async OLSKServiceWorkerDidFetch (event) {
				...
				// if (!(event.request.referrer.match(//review/) && event.request.mode === 'no-cors') && !event.request.url.match(//review/)) {
